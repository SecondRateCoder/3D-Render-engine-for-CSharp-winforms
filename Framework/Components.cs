...
#pragma warning restore CS8603
    ...
    public override string ToString(){ return this.filePath + $", Textured? {this.isEvenTextured}, Initialised? {this.Initialised}, Size in Texturer. ({this.DataStart}, {this.DataEnd})"; }
}
...
#pragma warning restore CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type
    ...
    public override string ToString(){ return this.MetaData.ToString() + $"Mass: {this.Mass}, Speed: {this.Speed}, Velocity: {this.velocity}, TrueVelocity: {this.TrueVelocity}"; }
